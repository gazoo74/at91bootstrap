...
CPPFLAGS += -DUBI_IMG_VOLNAME="\"$(CONFIG_UBI_IMG_VOLNAME)\""
CPPFLAGS += -DUBI_IMG_SPARE_VOLNAME="\"$(CONFIG_UBI_IMG_SPARE_VOLNAME)\""
ifeq ($(CONFIG_UBI_DTB),y)
CPPFLAGS += -DUBI_DTB_VOLNAME="\"$(CONFIG_UBI_DTB_VOLNAME)\""
CPPFLAGS += -DUBI_DTB_SPARE_VOLNAME="\"$(CONFIG_UBI_DTB_SPARE_VOLNAME)\""
endif
ifeq ($(CONFIG_UBI_INITRD),y)
CPPFLAGS += -DINITRD_ADDRESS=$(CONFIG_INITRD_ADDRESS)
CPPFLAGS += -DUBI_INITRD_VOLNAME="\"$(CONFIG_UBI_INITRD_VOLNAME)\""
CPPFLAGS += -DUBI_INITRD_SPARE_VOLNAME="\"$(CONFIG_UBI_INITRD_SPARE_VOLNAME)\""
endif
endif
