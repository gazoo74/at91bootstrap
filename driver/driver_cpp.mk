...
ifeq ($(CONFIG_LINUX_ITB), y)
CPPFLAGS += -DCONFIG_LINUX_ITB
endif
...
# UI stuff
ifeq ($(CONFIG_USER_FLASH_RECOVERY),y)
ifeq ($(ALLOW_DATAFLASH),y)
CPPFLAGS += -DCONFIG_DATAFLASH_RECOVERY
endif
ifeq ($(ALLOW_NANDFLASH),y)
CPPFLAGS += -DCONFIG_NANDFLASH_RECOVERY
endif
endif

ifeq ($(CONFIG_USER_KERNEL_EXTRA_ARGS),y)
CPPFLAGS += -DCONFIG_USER_PREPEND_CMDLINE="\"$(CONFIG_USER_PREPEND_CMDLINE) \""
endif

ifeq ($(CONFIG_USER_SET_ITB_CONFIGURATION),y)
CPPFLAGS += -DCONFIG_USER_ITB_CONFIGURATION="\"$(CONFIG_USER_ITB_CONFIGURATION)\""
endif
